    ...
    return (
        <div className='md:flex my-text'>
            ...
            <div className='md:w-1/2 md:mt-24'>
                <p className='flex text-3xl font-semibold md:mx-20 md:text-left text-center text-green-700 w-72'>Explore Your favourite city's food.</p>
                ...
                <button className='flex bg-green-700 p-2 text-white font-semibold items-center gap-2 mt-2 mx-20 rounded-full px-5'>Expolore <span><FaArrowRight></FaArrowRight></span></button>
            </div>
